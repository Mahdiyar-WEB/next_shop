...
const userSchema = new Schema(
  {
    ...
    role: {
      type: String,
      enum: ["USER", "ADMIN", "WRITER", "TEACHER"],
      default: "USER",
    },
...
const couponSchema = new Schema(
  {
    ...
    type: { type: String, enum: ["fixedProduct", "percent"], required: true },
...
const postSchema = new Schema(
  {
    ...
    related: [{ type: Schema.Types.ObjectId, ref: "Post" }],
  },
  { timestamps: true },
);
...
export const User = (models.User || model("User", userSchema)) as Model<
