        ...
        <nav className="flex items-center justify-between min-h-17">
          <div className="flex items-center gap-6 lg:gap-6 min-w-0">
            ...
            <div className="hidden lg:flex">
              {isDesktop && (
                <SearchBox
                  className="flex border border-secondary-100 bg-white/50 rounded-xl px-2 w-96 duration-150 focus-within:border-primary-500 focus-within:shadow-sm focus-within:shadow-primary-100"
